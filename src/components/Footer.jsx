            ...
            <section className="">
                <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-center mt-8 space-x-6">
                        ...
                        <a href="tel:+972538250965" className="text-mainColor bg-bgColor h-12 w-12 rounded-full flex items-center justify-center shadow-xl shadow-shineColor2 hover:shadow-shineColor3 duration-300">
                            <IoIosCall size={30} />
                        </a>

                        <a href="https://wa.me/972538250965?text=היי%20הגעתי%20מהאתר,%20אשמח%20לפרטים%20בנוגע%20לנוכחות%20דיגיטלית%20לעסק%20שלי" className="text-mainColor bg-bgColor h-12 w-12 rounded-full flex items-center justify-center shadow-xl shadow-shineColor2 hover:shadow-shineColor3 duration-300" target="_blank" rel="noopener noreferrer">
                            <FaWhatsapp size={30} />
                        </a>
                    ...
                    <p className="mt-8 text-base leading-6 text-center text-gray-400">
                        © 2024 Idanso, Inc. All rights reserved.
                    </p>
                </div>
            </section>
        </div>
